...
{
    [AutoloadBossHead]
    public class CrimsonWatcher : ModNPC
    {
        ...
        {
            DisplayName.SetDefault("Crimson Watcher");
        ...
        public override void SetDefaults()
        {
            ...
            bossBag = mod.ItemType("CrimsonWatcherBag"); // Needed for the NPC to drop loot bag.
            npc.scale = 3;
        }
        ...
        public override void AI()
        {
            ...
            if (npc.ai[0] <= 0)
            {
                ...
                if (randatk == 4)
                {
                    NPC.NewNPC((int)npc.position.X, (int)npc.position.Y, ModContent.NPCType<CrimsonShooter>());
                }
        ...
        private void Shoot()
        {
            int type = mod.ProjectileType("EvilPellet");
